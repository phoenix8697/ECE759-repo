...
#SBATCH --job-name=hadamard2_cuda_query_1024
#SBATCH --output="7_hadamard2-llama-2-13b-query-1024.out"
#SBATCH --error="7_hadamard2-llama-2-13b-query-1024.err"
#SBATCH --gres=gpu:1
...
for threads in 32 128 512 1024; do
  ./hadamard2_exec 5120 5120 1024 $threads \
